	...
	\end{block}
	  ...
	  \end{alertblock}
		...
		\begin{block}{Future Work}
			\rmfamily{There is significant room for improvement in Platipy, Spyral, and Conspyre.  There are several features of Spyral which are explained in the API but lack proper examples.  In the future, we plan to expand the documentation available on Platipy to include additional example projects that utilize more features of Spyral and can be used as the basis for new games.  We also plan on compiling a list of useful resources for game programmers including information on developing basic AI agents, incorporating multiplayer, and obtaining royalty-free audio and video.  We will also include all high-quality student projects for download so that they can be used by future students for reference.  Finally, the Spyral API will be expanded to efficiently utilize more features of the Pygame library.  }
		\end{block}
        \vskip2ex
